...
public class Joystick extends JoystickBase {
	...
	/**
	 * Construct an instance of a joystick. The joystick index is the USB port
	 ...
	 *
	 * @param hand
	 *            This parameter is ignored for the Joystick class and is only
